...
summary(lm_pa) # Should be a slope of 1, an intercept of 0, and a residual of sqrt(1) = 1
summary(lm_ch) # Should be a slope of 1, an intercept of 0, and a residual of sqrt(1) = 1
...
stanData = list(
	...
	n_hiddenState = n_hiddenState, # Dimension of the state space vector
...
results$save_output_files(dir = paste0("./", species, "/"), basename = "test_procErrorFixed_3rdOption_sqrt(1)",
	timestamp = FALSE, random = FALSE)
results$save_object(file = paste0("./", species, "/test_procErrorFixed_3rdOption_sqrt(1).rds"))
...
latent_dbh_array = compute_latent_dbh(latent_growth_array, latent_dbh_parents_array, indices, n_hiddenState)
...
latent = latent_dbh_array[, , paste0("latent_dbh[",
